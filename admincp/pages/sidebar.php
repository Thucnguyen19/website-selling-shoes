                ...
                <a href="pages/widgets.html" class="nav-link">
                  ...
                  <li class="nav-item has-treeview">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="categoryadd.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Thêm danh mục</p>
                              </a>
                          </li>
                  ...
                  <li class="nav-item has-treeview">
                      <a href="#" class="nav-link">
                          <i class="fa-brands fa-slack" style="color: #ffffff;"></i>
                          <p>
                              Thương hiệu
                              <i class="fas fa-angle-left right"></i>
                          </p>
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="brandadd.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item has-treeview">
                      <a href="#" class="nav-link">
                          <i class="fa-solid fa-box" style="color: #fbfbfb;"></i>
                          <p>
                              Sản phẩm
                              <i class="fas fa-angle-left right"></i>
                          </p>
                  ...
                  <li class="nav-item has-treeview">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="category_bloglist.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>danh sách danh mục</p>
                              </a>
                          </li>
                          ...
                          <li class="nav-item">
                              <a href="category_blogadd.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Thêm danh mục</p>
                              </a>
                          </li>
                  ...
                  <li class="nav-item has-treeview">
                      <a href="#" class="nav-link">
                          <i class="fa-solid fa-newspaper" style="color: #fefefe;"></i>
                          <p>
                              Tin tức
                              <i class="fas fa-angle-left right"></i>
                          </p>
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="bloglist.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                          ...
                          <li class="nav-item">
                              <a href="blogadd.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Thêm tin tức</p>
                              </a>
                          </li>
                  ...
                  <li class="nav-item has-treeview">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="sliderlist.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                          ...
                          <li class="nav-item">
                              <a href="slideradd.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Thêm slider</p>
                              </a>
                          </li>
...
?>
                  <li class="nav-item has-treeview">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="adminadd.php" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Thêm tài khoản</p>
                              </a>
                          </li>
